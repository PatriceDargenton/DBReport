        ...
        For i As Integer = 0 To sortKeys.Length - 1
            ...
            Else
                If IsNothing(sortKey.PropertyInfo) Then
                    If Not m_bMsg Then
                        MsgBox(
                            "A sorting key can't be found : the specified field doesn't exists" & vbLf &
                            "or is not in public scope !" & vbLf &
                            GetType(T).ToString & " : " & sortKeys(i).sMemberName & " : " & m_sSorting,
