...
Module modUtil
    ...
    Public Sub ShowErrorMsg(ByRef ex As Exception,
        Optional sFctTitle$ = "", Optional sInfo$ = "",
    ...
    Public Sub TruncateChildTextAccordingToControlWidth(child As ToolStripStatusLabel,
